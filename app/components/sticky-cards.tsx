...
export default function StickyCards() {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-[#091B56] mt-10 md:mt-20 text-white pb-4 lg:pb-40 xl:pt-16 pt-10 relative min-h-screen"
    >
                  ...
                  <foreignObject x="30" y="30" width="640" height="230">
                    <div className="flex flex-col space-y-3 text-white leading-tight">
                      ...
                      <h3
                        ...
                        className="text-white text-[50px] md:text-[32px] lg:text-[40px] xl:text-[40px] font-bold uppercase tracking-[2px] md:tracking-[1.5px]"
                      />
