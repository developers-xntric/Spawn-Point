            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 w-full mb-6">
                        {/* Left Stat */}
                        <div className="bg-white/5 backdrop-blur-2xl rounded-2xl p-6 text-center md:w-[300px] w-full">
                        ...
                        {/* Right Stat */}
                        <div className="bg-white/5 backdrop-blur-2xl rounded-2xl p-6 md:p-8 text-center md:w-[300px] w-full">
                    ...
                    {/* Bottom Stat */}
                    <div className="bg-white/5 backdrop-blur-2xl rounded-2xl p-6 md:p-8 w-full text-center md:w-[300px]">
