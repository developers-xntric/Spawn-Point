...
export default function Footer() {
    ...
    //         case "discord":
    //             return (
    //                 <svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 25 19" fill="none">
    ...
    //         case "twitter":
    //             return (
    //                 <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" viewBox="0 0 23 21" fill="none">
                        ...
                        {/* <div className="flex flex-wrap md:justify-between lg:w-[100%] gap-2 lg:gap-3  w-full">
                            {socialLinks.map((social) => (
                                <Link
                                    key={social.icon}
                                    href={social.href}
                                    className="text-white hover:text-lime-400 transition-colors border border-white rounded-[5px] px-8 md:px-8 py-2 capitalize text-[12px] tracking-[1px]"
