...
const ContactForm = () => {
      ...
      <div className="max-w-[1200px] w-full flex flex-row gap-10">
        ...
        <div className="flex-[3] flex flex-col gap-5">
          ...
          <div className="flex items-center gap-5 mt-5">
            <span className="text-sm opacity-80">All fields are mandatory</span>
  ...
  <path d="M0 0.5H441.5" stroke="#273561"/>
          ...
          <div className="flex gap-5 mt-5">
            ...
            <span className="text-xl"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 25 19" fill="none">
