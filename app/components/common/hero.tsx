...
export default function HeroSection({ h1, h2, icon1, icon2, para, buttonText, icon1Style, icon2Style }: { h1?: string; h2?: string; icon1?: string; icon2?: string; para?: string; buttonText?: string; icon1Style?: string; icon2Style?: string; }) {
    return (
        <section className="bg-[#031347] min-h-[500px] lg:min-h-[650px] 2xl:min-h-[600px] flex items-center justify-center relative pt-22 md:pt-16 mb-12">
            ...
            <div className={`${icon1Style ? icon1Style : "absolute left-[10%]  md:left-[15%] xl:left-[30%] top-[20%] md:top-[30%]"}`}>
                <Image src={icon1 ? icon1 : "/icons/yes.png"} alt="Pizza decoration" width={55} height={50} className="object-contain" />
            </div>

            {/* Robot image - right side */}
            <div className={`${icon2Style ? icon2Style : "absolute right-[4%] md:right-[30%] top-[70%] md:top-[67%]"}`}>
                <Image src={icon2 ? icon2 : "/icons/arrow-top-right.png"} alt="Robot decoration" width={50} height={50} className="object-contain" />
            </div>
