    ...
    return (
        <section className="bg-[#031347] min-h-[600px] flex items-center justify-center relative py-16">
            ...
            <div className="text-center z-10">
                <h1 className="text-white text-[80px] font-fks font-bold uppercase tracking-wide">Real Projects</h1>
                <h2 className="text-[#BBFC00] text-[120px] font-fks font-bold uppercase tracking-wide leading-20">Real Impact</h2>
