                ...
                <div className="flex gap-6">
                    ...
                    <div className="bg-[#0a1f5c] rounded-lg px-6 flex flex-col md:flex-row gap-6">
                        <div className="relative">
                            <div className="flex absolute bottom-[20%] left-10 flex-col justify-center flex-1">
                    ...
                    {/* <div className="bg-[#0a1f5c] rounded-lg p-6 flex flex-col-reverse md:flex-row gap-6">
                        <div className="flex-1">
                            <div className="bg-gray-300 rounded-lg rounded-tl-3xl w-full h-40 md:h-full min-h-40" />
                        </div>
