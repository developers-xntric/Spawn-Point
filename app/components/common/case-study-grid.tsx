        ...
        <section className="bg-[#031347] py-10 md:py-16 px-4 md:px-8">
            <div className="2xl:max-w-[1440px] w-[90%] md:w-[85%] mx-auto space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-10 gap-6">
                    {/* Left card - 70% */}
                    <div className="md:col-span-7 relative rounded-lg md:rounded-2xl overflow-hidden group h-[300px] md:h-[400px]">
                        <Image
                    ...
                    {/* Right card - 30% */}
                    <div className="md:col-span-3 relative rounded-lg md:rounded-2xl overflow-hidden group h-[300px] md:h-[400px]">
                        <Image
