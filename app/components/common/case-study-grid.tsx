                    ...
                    <div className="bg-[#0a1f5c] rounded-lg px-6 flex flex-col md:flex-row gap-6">
                        <div className="relative">
                            <div className="flex absolute bottom-[17%] left-10 flex-col justify-center flex-1">
                                ...
                                <div>
                                    <button className="bg-[#BBFC00] text-[#031347] font-bold px-6 py-2 rounded-[5px] font-hel border border-transparent hover:bg-transparent hover:border-white hover:text-white">
                                        View Case Studies
                                    </button>
                                </div>
                            </div>
