  ...
  return (
    <section className="pb-10 md:pb-16 pt-4">
      <div className="2xl:max-w-[1440px] w-[90%] md:w-[85%] mx-auto">
        ...
        {/* Main Content Grid */}
        <div className="grid items-center gap-6 md:gap-2 grid-cols-1 lg:grid-cols-3 xl:gap-0 place-items-center justify-between">
          {/* Left Stats Cards */}
          <div className="space-y-6 flex flex-col w-full">
            {/* Card 1 */}
            <div className="rounded-[12px] md:rounded-lg border border-[#FFFFFF1A] backdrop-blur-[30px] bg-white/5 pt-4 md:pt-10 pb-4 pl-4 ">
            ...
            {/* Card 2 */}
            <div className="rounded-[12px] md:rounded-lg border border-[#FFFFFF1A] backdrop-blur-[30px] bg-white/5 pt-5 md:pt-10 pb-4 pl-4 ">
