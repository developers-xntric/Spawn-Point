...
export default function HeroSection() {
    ...
    return (
        <section className="bg-[#031347] min-h-[700px] 2xl:min-h-[800px] flex items-center justify-center relative pt-16 mb-12">
            ...
            <div className="absolute right-[30%] top-[67%]">
                <Image src="/icons/arrow-top-right.png" alt="Robot decoration" width={50} height={50} className="object-contain" />
            </div>

            {/* Center content */}
            <div className="text-center z-10 mb-10">
                <h1 className="text-white text-[100px] font-fks font-bold uppercase tracking-wide">WE ARE</h1>
                <h2 className="text-[#BBFC00] text-[130px] font-fks font-bold uppercase tracking-wide leading-20">SPAWN POINT</h2>
                <p className="text-white text-md mt-6 max-w-sm mx-auto">
